...
void MD5InitDoge (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void MD5UpdateDoge (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void MD5FinalDoge (unsigned char digest[16], MD5_CTX *context)
{
  ...
  MD5UpdateDoge (context, PADDING, padLen);

  /* Append length (before padding) */
  MD5UpdateDoge (context, bits, 8);
...
void MD5(unsigned char strInputString[], unsigned char md5Digest[], unsigned int len){
	...
	MD5UpdateDoge(&ctx, strInputString, len);
	MD5FinalDoge(md5Digest, &ctx);
}
